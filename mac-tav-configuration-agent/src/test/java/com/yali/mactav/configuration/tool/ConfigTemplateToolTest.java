...
class ConfigTemplateToolTest {
    ...
    void shouldFindTemplateByFeature() {
        var response = tool.suggestConfigTemplate("SWITCH", "VLAN", "generic", 5);
    ...
    void shouldReturnWarningWhenNoTemplateMatches() {
        var response = tool.suggestConfigTemplate("FIREWALL", "VPN", "generic", 5);
    ...
    @Test
    void shouldNotThrowWhenArgumentsAreEmpty() {
        var response = tool.suggestConfigTemplate(null, null, null, null);
    ...
    void shouldNotContainExecutionActions() {
        var response = tool.suggestConfigTemplate(null, "ACL", null, 5);
